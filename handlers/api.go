...
// @title beacon.xertra.com Ethereum API Documentation
// @version 1.1
...
// @description If you required a higher usage plan please checkout https://beacon.xertra.com/pricing.
// @description The API key can be provided in the Header or as a query string parameter.
// @description
// @description Key as a query string parameter: `curl https://beacon.xertra.com/api/v1/slot/1?apikey=<your_key>`
// @description
// @description Key in a request header:  `curl -H 'apikey: <your_key>' https://beacon.xertra.com/api/v1/slot/1`
// @tag.name Epoch
...
// @tokenurl https://beacon.xertra.com/user/token
// @authorizationurl https://beacon.xertra.com/user/authorize
...
// ApiChart godoc
// @Summary Returns charts from the page https://beacon.xertra.com/charts as PNG
// @Tags Misc
// @Produce  json
...
// @Summary Used in eth2 clients to submit stats to your beacon.xertra.com account. This data can be accessed by the app or the user stats api call.
// @Tags User
// @Produce json
// @Param apikey query string true "User API key, can be found on https://beacon.xertra.com/user/settings"
...
func APIDashboardDataBalance(w http.ResponseWriter, r *http.Request) {
	...
	clPrice := price.GetStratisPrice(currency)
